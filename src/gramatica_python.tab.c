...
/* Line 189 of yacc.c  */
#line 97 "gramatica_python.tab.c"
...
/* Line 214 of yacc.c  */
#line 161 "gramatica_python.tab.c"
} YYSTYPE;
...
/* Line 264 of yacc.c  */
#line 173 "gramatica_python.tab.c"
...
{
       0,    70,    70,    79,    80,    88,    89,    96,   120,   137,
     153,   169,   184,   195,   214,   222,   234
};
#endif
...
static const char *const yytname[] =
{
  ...
  "DIVISION", "ASIGNACION", "PARENTESISIZQ", "PARENTESISDER", "IMPRIMIR",
  "NUMERO", "DECIMAL", "VARIABLE", "$accept", "codigo", "sentencias",
...
#line 96 "gramatica_python.y"
    {
        ...
        tabla[indice].nombre = (yyvsp[(1) - (3)].stringVal); tabla[indice].tipo = tipos[0]; tabla[indice].numero = (yyvsp[(3) - (3)].tr).numero; tabla[indice].registro = (yyvsp[(3) - (3)].tr).n->resultado;
        ...
        tabla[indice].nombre = (yyvsp[(1) - (3)].stringVal); tabla[indice].tipo = tipos[1]; tabla[indice].decimal = (yyvsp[(3) - (3)].tr).decimal; tabla[indice].registro = (yyvsp[(3) - (3)].tr).n->resultado;
        indice++; //incrementamos el valor del inidice para pasar a la siguiente posicion y dejar la anterior guardada
        }
...
/* Line 1464 of yacc.c  */
#line 222 "gramatica_python.y"
    {
        (yyval.tr).decimal = (yyvsp[(1) - (1)].decimalVal);
        printf("\n> [TIPO] - Decimal: %.3f\n", (yyval.tr).decimal); 
        (yyval.tr).n = crearNodoTerminal((yyvsp[(1) - (1)].decimalVal)); 
...
/* Line 1464 of yacc.c  */
#line 1572 "gramatica_python.tab.c"
      default: break;
    }
